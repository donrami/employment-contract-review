# Pitfall Catalog — Master Reference for German Employment-Contract Assessment

**As of 2026-08.** This catalog enumerates the recurring legal pitfalls the skill must detect when assessing German employment contracts. Legal bases were verified against statute text and BAG/BVerfG/EuGH decisions via web research on 2026-08-22; all citations carry URLs. Case numbers without a confirming source are marked `[unverified]`. Severity reflects the employee-protective default of German labor law: formular (pre-formulated, AGB) clauses are construed against the drafter (§ 305c Abs. 2 BGB) and are invalid if they disadvantage the employee contrary to good faith (§ 307 Abs. 1 BGB), which statutory provisions cannot remedy (§ 307 Abs. 2 Nr. 1 BGB).

> **Append-only note:** Entries are append-only after publication. New pitfalls get P62+; existing IDs are never renumbered or deleted. Corrections are made by adding a new entry and, where necessary, noting the supersession.
...
```
- **Recommended fix wording:** Use the term "Probezeit", cap at six months, and keep any reduced notice period inside that window:
```text
...
```
- **Recommended fix wording:** Cap at 24 months with max. 3 extensions total (a 4th renewal voids it); if longer is needed, draft an objective Sachgrund under § 14 Abs. 1 TzBfG (Vertretung, Projektbezug, etc.) with the ground stated in the contract:
```text
...
```
- **Uncertainty:** The Vorbeschäftigungsverbot (§ 14 Abs. 2 Satz 2 TzBfG) was softened only for pensioners (§ 41 Abs. 2 SGB VI, in force 1.1.2026; scope for never-employed-by-this-employer pensioners debated — IHK München flags the point as "umstritten"). For all other employees the prohibition applies irrespective of the gap since prior employment. A July-2026 coalition reform proposal (48 months / 6 renewals until end-2030) is **not law** as of 2026-08.
...
```
- **Recommended fix wording:** No chain without a genuine, documented Sachgrund per extension; where possible, convert to an indefinite contract. For pensioners, § 41 Abs. 2 SGB VI (since 1.1.2026) permits repeated sachgrundlose Befristung up to 8 years total / 12 contracts — https://www.ihk-muenchen.de/ratgeber/recht/arbeitsrecht/bestehende-arbeitsverhaeltnisse-kuendigung-sozialversicherung/befristete-beschaeftigung-rentner/
...
```
- **Recommended fix wording:** Written, signed (or qualified e-signature per § 126a BGB) amendment referencing the original contract and expressly stating the new end date and that all other terms continue:
```text
...
```
- **Recommended fix wording:** Cap duration (typically ≤ 1–2 years), justify with a business interest, and compensate the employee (e.g. wage guarantee, Abfindung); or delete and rely on § 622 BGB:
```text
...
```
- **Recommended fix wording:** Delete the clause. If garden leave is needed, negotiate it individually with compensation (e.g. vacation crediting, bonus protection) or rely on the employer's one-sided right of release only where a legitimate interest exists (e.g. Wettbewerbsverbot, Zugangskontrolle):
```text
...
```
- **Recommended fix wording:** Bounded variant with objective trigger and no circumvention of § 613a BGB:
```text
...
- **Name:** Verzicht auf Teilzeitrechte (§ 8/9a TzBfG) / Waiver of part-time rights
- **Category:** Duration & termination / Special clauses
- **Clause type:** Part-time / waiver clause
- **Why it is a problem:** § 8 TzBfG grants employees (employer > 15 employees) a right to reduce working hours with 3 months' lead; refusal is only possible for operational reasons, and an unanswered, timely application is **deemed granted** (§ 8 Abs. 5 TzBfG Fiktion). § 9a TzBfG (Brückenteilzeit, employer > 45 employees, tenure > 6 months) grants a right to a temporary reduction of 1–5 years. A contract clause waiving these rights in advance, or "announcing-deadline tricks" that steer the employee past the § 8 Abs. 2 Satz 2 TzBfG deadline, is ineffective and AGB-invalid: the statutory rights are non-waivable and the employee can invoke them notwithstanding the waiver.
- **Legal basis:** §§ 8, 9a TzBfG — https://www.gesetze-im-internet.de/tzbfg/__8.html ; https://www.gesetze-im-internet.de/tzbfg/__9a.html ; BAG, Urt. v. 07.09.2021 – 9 AZR 595/20 (application missing the announcement deadline does not trigger the fiction — the claim fails) — https://dejure.org/dienste/vernetzung/rechtsprechung?Gericht=BAG&Datum=07.09.2021&Aktenzeichen=9%20AZR%20595%2F20 ; new: BAG, Urt. v. 27.01.2026 – 9 AZR 32/25 (tariff limitation of part-time) — https://dejure.org/dienste/vernetzung/rechtsprechung?Gericht=BAG&Datum=27.01.2026&Aktenzeichen=9%20AZR%2032%2F25
- **Severity:** Medium
- **Typical clause language:**
```text
Der Arbeitnehmer verzichtet unwiderruflich auf die Geltendmachung von Ansprüchen auf Verringerung oder zeitlich begrenzte Verlängerung seiner Arbeitszeit nach §§ 8, 9a TzBfG. Anträge auf Teilzeit sind ausschließlich bis zum [Datum, vor dem gesetzlichen Ankündigungszeitpunkt] zu stellen.
```
- **Recommended fix wording:** Delete the waiver; reference the statutory rights:
```text
Ansprüche auf Verringerung oder Verlängerung der Arbeitszeit richten sich nach den §§ 8, 9a TzBfG. Anträge sind unter Beachtung der gesetzlichen Ankündigungsfristen zu stellen.
```
- **Uncertainty:** The § 8 Abs. 5 TzBfG Fiktion applies only to timely, complete applications; BAG 9 AZR 595/20 confirms the deadline is strict, so clauses must not mislead about it. BAG 9 AZR 32/25 (27.01.2026) addresses tariff-based limitations — watch for further development.
...
```
- **Recommended fix wording:** Verify hourly rate ≥ 13,90 € (2026) / 14,60 € (2027) after dividing monthly pay by actual hours; add a compliance statement and avoid all-inclusive "Abgeltung" of overtime in low-wage bands (see P12):
```text
...
```
- **Recommended fix wording:** Quantify:
```text
...
```
- **Recommended fix wording:** Define targets, weighting, payout corridor, and a duty to set objectives:
```text
...
```
- **Recommended fix wording:** Tier the binding period to the amount; max. 31.03. (<1 monthly salary) or max. 30.06. (≥1 monthly salary); never for pure past-work compensation:
```text
...
```
- **Recommended fix wording:** Neutral, criteria-based grading (Tätigkeit, Verantwortung, Erfahrung, Leistung); remove pay-secrecy clauses (they conflict with § 10 EntgTranspG); prepare pay-range disclosure for job postings for the upcoming Umsetzungsgesetz:
```text
...
```
- **Recommended fix wording:** Prospective-only adjustment with objective triggers and equitable balancing:
```text
...
- **Legal basis:** §§ 3, 7, 13 BUrlG; BAG, Urt. v. 19.02.2019 – 9 AZR 541/15 — https://www.bag-urteil.com/19-02-2019-9-azr-541-15 ; BAG, Urt. v. 19.02.2019 – 9 AZR 423/16 — https://www.arbeitsrecht-rheinland-pfalz.de/bundesarbeitsgericht/detailansicht/artikel/jahresurlaub-darf-auch-bei-laengerer-krankheit-nicht-einfach-verfallen.html ; EuGH C-214/10 (Schulte-Hostedde) — https://www.hensche.de/Urlaub_Krankheit_Urlaub_und_Krankheit_Krankheitsbedingt_nicht_genommener_Urlaub_kann_nach_15_Monaten_verfallen_EuGH_C214-10_KHS-gg-Schulte.html
- **Severity:** High
- **Typical clause language:**
```text
...
- **Legal basis:** BAG, Beschl. v. 13.09.2022 – 1 ABR 22/21 — https://www.bundesarbeitsgericht.de/entscheidung/1-abr-22-21 ; § 16 Abs. 2 ArbZG; Reform-Referentenentwurf (elektronische Aufzeichnung) still pending — https://www.esche.de/news-wissen/esche-blog/elektronische-arbeitszeiterfassung-geplante-aenderungen-des-arbeitszeitgesetzes
- **Severity:** Medium
- **Typical clause language:**
```text
(Fehlende Regelung) Überstunden sind gesondert zu beantragen; eine systematische Zeiterfassung erfolgt nicht.
```
- **Recommended fix wording:** Implement a recording system and reflect it in the contract:
```text
...
```
- **Uncertainty:** The ArbZG amendment (electronic recording duty) has not passed as of 2026-08; but the BAG obligation applies already. Watch the legislator: reform announced for 2026 (`law_in_flux`).
...
```
- **Recommended fix wording:** Cap at 24 months (see P23).
- **Uncertainty:** None.
...
```
- **Recommended fix wording:** Narrow scope + list + time limit + no disguised non-compete:
```text
...
```
- **Recommended fix wording:** Delete penalty for termination entirely; if a penalty is needed (e.g. non-compete breach), tie it to the concrete breach with a cap:
```text
...
```
- **Recommended fix wording:** Reference the ArbEG procedure instead:
```text
...
```
- **Recommended fix wording:** Replace waiver with a commitment to issue a qualified reference:
```text
...
```
- **Recommended fix wording:** Separate, specific, revocable consent; rely primarily on § 26 Abs. 1 BDSG (Vertragsdurchführung) and Art. 6 Abs. 1 lit. b GDPR:
```text
...
```
- **Recommended fix wording:** Purpose-bound, transparent, proportionate; separate policy:
```text
...
```
- **Recommended fix wording:** Consent model with objective criteria:
```text
...
```
- **Recommended fix wording:** Delete exclusivity; keep only the concrete-impairment rule (see P35). If the employer genuinely needs exclusivity (e.g. senior management), negotiate individually with real compensation and objective boundaries.
...
```
- **Recommended fix wording:** Delete; rely on statutory extension:
```text
...
```
- **Recommended fix wording:** Delete; the statutory rights are non-waivable. Standard: no contractual clause needed — statute applies.
- **Uncertainty:** None.
...
```
- **Recommended fix wording:** Delete; reference statute:
```text
...
```
- **Recommended fix wording:** Delete; no health/disability statements in the contract:
```text
...
```
- **Recommended fix wording:** Pin the reference to the employer's own tariff binding and provide a fallback:
```text
...
```
- **Recommended fix wording:** No such clause — § 613a Abs. 1 Satz 2 BGB continues collective terms; changes require a lawful Änderungskündigung or individual agreement after proper information:
```text
...
```
- **Recommended fix wording:** Choose German law for work performed in Germany, or add a protective clause:
```text
...
```
- **Recommended fix wording:** Include all § 2 NachwG items as a checklist; e.g. add:
```text
...
```
- **Recommended fix wording:** Use a QES provider for Schriftform documents or wet-ink; state the form requirement explicitly:
```text
...
```
- **Recommended fix wording:** Delete or correct:
```text
...
- **Name:** Ausschlussfristen zu kurz oder zu weitreichend / Forfeiture clauses too short or blanket
- **Category:** Formalities & documentation / Special clauses
- **Clause type:** Forfeiture/claim-bar clause
- **Why it is a problem:** A valid forfeiture clause in a form employment contract must have at least two stages: written assertion within at least 3 months, then judicial assertion within at least 3 months after rejection (BAG 25.05.2005 – 5 AZR 572/04). Clauses with a shorter first stage are invalid (BAG 28.05.2014 – 5 AZR 422/12). A blanket clause covering "all claims" is void insofar as it covers claims for intentional breach (Vorsatzhaftung, § 276 Abs. 3 BGB; BAG 26.11.2020 – 8 AZR 58/20) and — since 2015 — minimum-wage claims (BAG 18.09.2018 – 9 AZR 162/18). The written-claim requirement must not be tightened to an unachievable form (e-mail may suffice where the clause does not demand more; BAG 16.12.2009 – 5 AZR 888/08).
- **Legal basis:** § 307 BGB; § 276 Abs. 3 BGB; BAG, Urt. v. 25.05.2005 – 5 AZR 572/04 — https://datenbank.nwb.de/Dokument/207928/ ; BAG, Urt. v. 28.05.2014 – 5 AZR 422/12 (equal-pay; 3-month minimum) — https://www.hensche.de/Rechtsanwalt_Arbeitsrecht_Handbuch_Ausschlussfristen.html ; BAG, Urt. v. 26.11.2020 – 8 AZR 58/20 (Vorsatz) — https://testphase.rechtsinformationen.bund.de/case-law/KARE600061615 ; https://rsw.beck.de/aktuell/daily/meldung/detail/bag-arbeitsvertragliche-ausschlussklausel-auf-verfall-aller-ansprueche-ist-unwirksam ; BAG, Urt. v. 18.09.2018 – 9 AZR 162/18 (Mindestlohn) — https://www.bundesarbeitsgericht.de/presse/mindestlohn-arbeitsvertragliche-ausschlussfrist/ ; BAG, Urt. v. 16.12.2009 – 5 AZR 888/08 (Schriftform per E-Mail) — https://www.hensche.de/Arbeitsrecht_aktuell_Ausschlussfrist_Schriftform_Geltendmachung_E-Mail_BAG_5AZR888-08.html ; case-law whitelist: `case-law.md` (5 AZR 888/08)
- **Severity:** High
- **Typical clause language:**
```text
Alle Ansprüche aus dem Arbeitsverhältnis verfallen, wenn sie nicht innerhalb von zwei Monaten nach Fälligkeit schriftlich geltend gemacht werden. Sämtliche Ansprüche sind nach Ablauf dieser Frist ausgeschlossen, auch solche aus vorsätzlichen Pflichtverletzungen und gesetzlichen Mindestlohnansprüchen.
```
- **Recommended fix wording:** Two-stage clause with a 3-month minimum first stage, excluding Vorsatz and Mindestlohn claims:
```text
Ansprüche aus dem Arbeitsverhältnis sind innerhalb von drei Monaten nach Fälligkeit schriftlich geltend zu machen. Wird der Anspruch abgelehnt oder äußert sich der Arbeitgeber nicht innerhalb von zwei Wochen nach Geltendmachung, ist der Anspruch innerhalb von drei Monaten nach der Ablehnung bzw. dem Fristablauf gerichtlich geltend zu machen. Diese Ausschlussfristen gelten nicht für Ansprüche aus vorsätzlichen Pflichtverletzungen (§ 276 Abs. 3 BGB) und für gesetzliche Mindestlohnansprüche.
```
- **Uncertainty:** The 3-month minimum for the first stage is settled; single-stage clauses are invalid; the written-claim requirement may be satisfied by e-mail if the clause's wording permits (BAG 16.12.2009 – 5 AZR 888/08).
...
```
- **Recommended fix wording:** Bound the waiver to known, enumerated claims; exclude statutory non-waivable rights; keep Schriftform:
```text
...
```
- **Recommended fix wording:** Align with statute:
```text
...
```
- **Recommended fix wording:** Replace with an annual review/negotiation clause (not automatic indexation):
```text
...
```
- **Recommended fix wording:** Delete the arbitration part; keep only a voluntary, non-blocking mediation clause:
```text
...
- **Name:** AÜG-Konstellationen / Temp-agency (Leiharbeit) contract issues
- **Category:** Special clauses / Cross-border & posting
- **Clause type:** Temp-agency clause
- **Why it is a problem:** If an assignment is made without an AÜG permit, the contracts are void and employment is deemed to exist with the user undertaking (§§ 9, 10 AÜG Fiktion). Equal pay/conditions with comparable employees of the user is the statutory rule (§ 8 AÜG Gleichstellungsgrundsatz); deviation requires a sectoral collective agreement and, after 9 months, the deviation ends (max. 15 months step-up). The maximum assignment duration is 18 months to the same user (§ 17a AÜG); exceeding it triggers the deemed-employment fiction. Fee-splitting is prohibited (§ 9 Abs. 2 AÜG). A contract clause that waives equal pay, extends the assignment beyond 18 months, or shifts permit responsibility to the employee is void/ineffective.
- **Legal basis:** §§ 8, 9, 10, 13, 17a AÜG — https://www.gesetze-im-internet.de/a_g/__8.html ; https://www.haufe.de/personal/arbeitsrecht/reform-der-zeitarbeit/arbeitnehmerueberlassung-dauer-auf-18-monate-begrenzt_76_433684.html ; https://belonio.de/hr-glossar/arbeitnehmerueberlassungsgesetz/
- **Severity:** High
- **Typical clause language:**
```text
Der Arbeitnehmer wird als Leiharbeitnehmer bei Kundenunternehmen eingesetzt. Ein Anspruch auf gleiche Arbeitsbedingungen wie bei den Kundenunternehmen besteht nicht; die Überlassung kann die gesetzliche Höchstdauer überschreiten. Für die Erlaubnis nach dem AÜG ist der Arbeitnehmer selbst verantwortlich.
```
- **Recommended fix wording:**
```text
Die Überlassung an Kundenunternehmen erfolgt ausschließlich im Rahmen einer gültigen Erlaubnis nach § 1 AÜG und unter Beachtung des Gleichstellungsgrundsatzes nach § 8 AÜG sowie der Überlassungshöchstdauer von 18 Monaten nach § 17a AÜG. Eine Abweichung vom Gleichstellungsgrundsatz ist nur auf Grundlage eines anwendbaren Tarifvertrags zulässig.
```
- **Uncertainty:** Tariff derogation mechanics (which sectoral TV applies) are case-specific; the 18-month cap can be extended by collective agreement — verify the applicable TV.

### P61 — Insolvency clauses
- **Name:** Insolvenzklauseln / Insolvency-related clauses
- **Category:** Special clauses
- **Clause type:** Insolvency clause
- **Why it is a problem:** On insolvency, employment relationships continue with the insolvency estate (§ 108 InsO); the insolvency administrator may terminate with **3 months' notice** regardless of longer contractual notice periods, without KSchG social justification (§ 113 InsO); pre-insolvency wage claims are Insolvenzforderungen (quota), post-opening wages are Masseverbindlichkeiten (§ 55 InsO); Insolvenzgeld (§§ 165 ff. SGB III) covers the last 3 months. Contract clauses purporting to shorten the administrator's notice, to terminate automatically on insolvency, or to waive claims in anticipation of insolvency are void: the statutory rules are mandatory and override the clause (§§ 134, 138 BGB).
- **Legal basis:** §§ 108, 113, 55 InsO — https://www.gesetze-im-internet.de/inso/__108.html ; https://www.gesetze-im-internet.de/inso/__113.html ; Insolvenzgeld §§ 165 ff. SGB III
- **Severity:** Medium
- **Typical clause language:**
```text
Mit der Eröffnung des Insolvenzverfahrens endet das Arbeitsverhältnis kraft Gesetzes. Ansprüche aus der Zeit vor der Insolvenz sind verwirkt. Die Kündigungsfrist des Insolvenzverwalters wird auf zwei Wochen verkürzt.
```
- **Recommended fix wording:** Delete; reference the statutory regime:
```text
(Streichen) — Bei Eröffnung eines Insolvenzverfahrens gelten die §§ 108, 113 InsO: Das Arbeitsverhältnis besteht gegenüber der Insolvenzmasse fort; der Insolvenzverwalter kann mit einer Frist von drei Monaten kündigen. Ansprüche richten sich nach den §§ 55, 108 InsO; Insolvenzgeldansprüche bleiben unberührt.
```
- **Uncertainty:** None on the statutory override; the administrator's 3-month notice applies regardless of contractual or tariff notice periods.
...
- Verified BAG decisions cited with case numbers and dates: 5 AZR 517/09 (01.09.2010), 5 AZR 406/10 (17.08.2011), 10 AZR 97/07 (12.12.2007), 10 AZR 290/17 (27.06.2018), 10 AZR 26/12 (16.01.2013), 9 AZR 464/00 (11.12.2001), 1 ABR 22/21 (13.09.2022), 9 AZR 541/15 (19.02.2019), 2 AZR 160/24 (30.10.2025), 2 AZR 96/24 (B) (18.06.2025), 5 AZR 108/25 (25.03.2026), 5 AZR 595/17 (11.07.2018), 5 AZR 553/17 (17.10.2018), 6 AZR 75/18 (07.02.2019), 2 AZR 582/13 + 8 AZR 130/13 (23.01.2014), 10 AZR 162/24 (30.10.2024), 5 AZR 700/09 (01.09.2010), 5 AZR 572/04 (25.05.2005), 5 AZR 422/12 (28.05.2014), 8 AZR 58/20 (26.11.2020), 9 AZR 162/18 (18.09.2018), 5 AZR 888/08 (16.12.2009), 9 AZR 595/20 (07.09.2021), 9 AZR 32/25 (27.01.2026), 10 AZR 177/12 (20.02.2013), 2 AZR 597/16 (29.06.2017), 8 AZR 12/86 (18.11.1988), 7 AZR 140/15 (26.10.2016), 8 AZR 300/24 (23.10.2025).
